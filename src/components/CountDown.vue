<template>
  <div id="countdown" class="text-center bg-local bg-center bg-cover w-full flex flex-col justify-center items-center h-96">
...
<style scoped>
  #countdown {
    background-image: url('~@/assets/bg_countdown2.jpg');
