...
methods: {
    ...
    sumbit(e) {    
        ...
        console.log(r)
        var names = [ "nagy", "tothy", "anka", "miki", "susedia", "palovci", "mareckovci",  "szabovci", "samsonovci", "dusan", "technici", "varga", "veronika", "nela", "ujopeto", "ujoluky", "nemecek", "dresto", "jusko", "petrov", "macky", "mato", "masaryk", "sestricka", "hrinkovci", "ulicna", "billy", "svarcovci", "matich", "halaga", "havadej", "holodnakova", "marcinkovci", "palko", "patka", "tothova", "vargovci", "pvp", "bulikovci", "gutyan", "hurtikovci", "sabovci", "steiner", "steinerovci", "vojtko", "brasko", "dxc", "huda", "thily", "jacques", "ele", "alma", "milka", "hrusovska", "ocko", "onofrejovci", "simovci", "horvathovci" ];
        if(names.includes(r)){
